...
<ol class="breadcrumb">
    ...
    <li><a href="/admin/cadastro/personais">Personais</a></li>
...
<div class="box">
    <div class="box-header">
        ...
        <a href="{{ route('personais')}}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"> Voltar</i></a>
    </div>
    <div class="box-body">
        @if(session('sucess'))
        ...
        <form action="#" class="form-horizontal" method="post">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="salario">Salário: *</label>
                <div class="col-sm-7">
                    <input id="salario" name="salario" class="form-control" placeholder="Salário">
                </div>
            </div>
